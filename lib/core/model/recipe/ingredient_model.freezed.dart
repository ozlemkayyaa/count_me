...
mixin _$IngredientModel {
  String? get name => throw _privateConstructorUsedError; // Malzemenin Adı
  double? get amount => throw _privateConstructorUsedError; // Miktarı
...
class _$IngredientModelImpl implements _IngredientModel {
  const _$IngredientModelImpl({this.name, this.amount, this.unit});
...
// Miktarı
  ...
  @override
  String toString() {
    return 'IngredientModel(name: $name, amount: $amount, unit: $unit)';
  }
...
abstract class _IngredientModel implements IngredientModel {
  const factory _IngredientModel(
      {final String? name,
      final double? amount,
      final String? unit}) = _$IngredientModelImpl;

  factory _IngredientModel.fromJson(Map<String, dynamic> json) =
      _$IngredientModelImpl.fromJson;

  @override
  String? get name; // Malzemenin Adı
  @override
  double? get amount; // Miktarı
  @override
  String? get unit;
