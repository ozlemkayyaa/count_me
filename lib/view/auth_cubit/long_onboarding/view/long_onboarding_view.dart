...
import 'package:count_me/view/auth_cubit/long_onboarding/view/activity/activity_group.dart';
import 'package:count_me/view/auth_cubit/long_onboarding/view/health/health_group.dart';
import 'package:count_me/view/auth_cubit/long_onboarding/view/plan/plan_group.dart';
import 'package:count_me/view/auth_cubit/long_onboarding/view/profile/profile_group.dart';
...
class _LongOnboardingViewState extends BaseState<LongOnboardingView> {
  ...
  Widget build(BuildContext context) {
    return BaseView<LongOnboardingCubit, GenericCubitState>(
      cubit: LongOnboardingCubit(),
      onPageBuilder: (context, cubit, state) {
        ...
        if (state.status == Status.initial || state.status == Status.success) {
          return longOnboardingBody(context);
        }
